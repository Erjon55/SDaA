...
public class PipeAndFilterProblem {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Pipe<String> groupedCoursePipe = new Pipe<String>();
        LowerCaseFilter lowerCaseFilter = new LowerCaseFilter();
        RemoveNamesFilter removeNamesFilter = new RemoveNamesFilter();
        CourseToGroupFilter courseToGroupFilter = new CourseToGroupFilter();
        RemoveLastCharFilter removeLastCharFilter = new RemoveLastCharFilter();

        groupedCoursePipe.addFilter(lowerCaseFilter);
        groupedCoursePipe.addFilter(removeNamesFilter);
        groupedCoursePipe.addFilter(removeLastCharFilter);
        groupedCoursePipe.addFilter(courseToGroupFilter);
        groupedCoursePipe.addFilter(removeLastCharFilter);

        Pipe<String> substractFromGradePipe = new Pipe<String>();
        SubstractFilter substractFilter = new SubstractFilter();
        substractFromGradePipe.addFilter(substractFilter);
        substractFromGradePipe.addFilter(removeNamesFilter);
        substractFromGradePipe.addFilter(removeLastCharFilter);
